...
__title__ = "Path Jet/Plasma/Laser Operation"
__author__ = "Dave Seff"
__url__ = "http://www.freecadweb.org"
__doc__ = "Path Jet cutting operation based on entire model, selected faces or selected edges."
__contributors__ = ""
...
class ObjectProfile(PathAreaOp.ObjectOp):
    '''Proxy object for Jet Cutting operations based on faces.'''
    ...
    def initAreaOpProperties(self, obj, warn=False):
        ...
        if len(self.addNewProps) > 0:
            ...
            if warn:
                newPropMsg = translate('PathJet', 'New property added to')
                newPropMsg += ' "{}": {}'.format(obj.Label, self.addNewProps) + '. '
                newPropMsg += translate('PathJet', 'Check its default value.') + '\n'
